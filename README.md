...
2. Run the stack (Frontend + Backend)
...
- `apps/web`: Next.js frontend — game canvas, wallet connection (RainbowKit), channel signing.
- `apps/server`: Node.js/Express + Socket.io — orchestrates rooms and relays signed state updates between players.
